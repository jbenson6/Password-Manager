...
import application.AreYouSureController;
...
public class LoginManager {
	...
	void showAddView(ResultSet userID) {
	...
	void showEditUserView(ResultSet userID) throws SQLException {
		// TODO Auto-generated method stub
		try {
			FXMLLoader loader = new FXMLLoader(
	...
	void showAreYouSureView(ResultSet userID) throws Exception {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("areyousure.fxml")
					);
			scene.setRoot((Parent) loader.load());
			AreYouSureController controller = loader.<AreYouSureController>getController();
			controller.initSessionID(this, userID);
		} catch (IOException ex) {
			Logger.getLogger(LoginManager.class.getName()).log(Level.SEVERE, null, ex);
		}
